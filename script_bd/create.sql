...
(
     igdt_pdt_id varchar(70) not null,
     cantidad_igdt_pdt varchar(70) not null,
     ingrediente_id varchar(70) not null,
...
( 
     ...
     cantidad_pdt_cb varchar(70) not null,
     producto_id varchar(70) not null,
...
( 
     ...
     tiempo_aprox_preparacion_combo varchar(5) not null,
