  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "lugar" ("id_lugar" character varying NOT NULL, "nombre_lugar" character varying(100) NOT NULL, "tipo_lugar" "public"."lugar_tipo_lugar_enum" NOT NULL, "precio_lugar" real, "id_padre_lugar" character varying, CONSTRAINT "PK_cf9bdfa039e2b22abd655f48cd5" PRIMARY KEY ("id_lugar"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "combo" ("combo_id" character varying NOT NULL, "nombre_combo" character varying(300) NOT NULL, "tiempo_aprox_preparacion_combo" character varying(300) NOT NULL, "precio_lugar_unitario_combo" character varying(300) NOT NULL, CONSTRAINT "PK_8d813bcc2c55a1b44a857e51ff1" PRIMARY KEY ("combo_id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "cliente" ADD CONSTRAINT "FK_8e062baa9659cb6b502ae261c15" FOREIGN KEY ("id_lugar_cliente") REFERENCES "lugar"("id_lugar") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "lugar" ADD CONSTRAINT "FK_cf46a9678fa544bdc0fa96bf7e2" FOREIGN KEY ("id_padre_lugar") REFERENCES "lugar"("id_lugar") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lugar" DROP CONSTRAINT "FK_cf46a9678fa544bdc0fa96bf7e2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cliente" DROP CONSTRAINT "FK_8e062baa9659cb6b502ae261c15"`,
    );
